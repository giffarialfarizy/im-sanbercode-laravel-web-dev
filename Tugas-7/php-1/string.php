...
<body>
    ...
    <?php   
        ...
        */
        ...
        echo "Jumlah kata string first_sentence: " . str_word_count($first_sentence) . "<br><br>";

        echo "second_sentence: " . $second_sentence . "<br>";
        echo "Panjang string second_sentence: " . strlen($second_sentence) . "<br>";
        echo "Jumlah kata string second_sentence: " . str_word_count($second_sentence) . "<br>";
        ...
        */
        ...
        echo "<br>New string: \"$new_string3\" "; // OUTPUT : "PHP is old but awesome"
